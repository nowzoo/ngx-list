...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ngx-list documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/NgxListFnFactory.html" data-type="entity-link">NgxListFnFactory</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/INgxListInit.html" data-type="entity-link">INgxListInit</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/INgxListParams.html" data-type="entity-link">INgxListParams</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/INgxListResult.html" data-type="entity-link">INgxListResult</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
